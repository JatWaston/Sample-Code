...
- (void)viewDidLoad {
    ...
    self.player.view.frame = CGRectMake(0, 20, self.view.frame.size.width, 200);// self.view.bounds;
    self.player.view.autoresizingMask = UIViewAutoresizingFlexibleWidth;
